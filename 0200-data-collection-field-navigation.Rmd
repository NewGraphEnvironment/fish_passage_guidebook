...
```{r timestamp-settings, fig.cap = "Navigate to the Timestamp settings by pressing the 'clock' icon in the bottom right corner when in the timestamp app.", out.width='50%'}
